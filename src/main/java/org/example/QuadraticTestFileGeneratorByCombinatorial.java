...
public class QuadraticTestFileGeneratorByCombinatorial {

    public static void main(String[] args) {
        String inputFilePath = "src\\main\\resources\\Quadratic-3way-output.csv";
        String outputFilePath = "src\\test\\java\\org\\example\\QuadraticCombinatorialTest.java";
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter(outputFilePath))) {
            ...
            writer.println();
            writer.println("public class QuadraticCombinatorialTest {");
            writer.println();
