 ...
 * Assignment 4
 *
 * A org.example.Quadratic Equation Solver. Real and complex roots are supported, but not complex coefficients. Loss of precision due to round-off
 * error and other conditions is detected where possible and computation is aborted. A mixed approach is used in place of the org.example.Quadratic Formula to avoid
...
public class Quadratic {
    ...
    public static void main(String[] args) {
        ...
        // welcome message
        System.out.println("Welcome to org.example.Quadratic Equation Solver.\n" +
        ...
        // goodbye
        System.out.println("Thank you for using org.example.Quadratic Equation Solver!");

    }

    static class NotEnoughPrecisionException extends Exception {
    }
}